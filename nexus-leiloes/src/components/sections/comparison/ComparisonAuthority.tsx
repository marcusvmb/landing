      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex justify-center mb-4">
              <div className="flex -space-x-2">
                ...
                <div
                  ...
                  "
                >
                  <span className="text-white text-xs font-bold">+542</span>
                </div>
              </div>
            </div>
            ...
            <p className="mt-4 text-[#5C5CFF] font-semibold">
              547 profissionais já fizeram a escolha certa
            </p>
          </div>
        </div>
