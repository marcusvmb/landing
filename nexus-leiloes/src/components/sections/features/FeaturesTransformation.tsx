...
const transformations = [
  ...
  },
  {
    ...
    toState: '5 cenarios simulados',
    toDesc: 'Precisão total em cada decisao de investimento',
    size: 'featured',
    badge: 'EXCLUSIVO',
  },
  {
  ...
  },
  {
    ...
    fromDesc: 'Descobrir ocupacao após o arremate',
    toState: 'Consulta previa',
    toDesc: 'Situacao do imóvel antes de dar lance',
    size: 'half',
    badge: null,
  },
  {
    ...
    fromDesc: 'Gestao manual e desorganizada',
    toState: 'Portfolio organizado',
    toDesc: 'Multi-cliente com visao profissional',
    size: 'half',
    ...
    >
      ...
      <div
        className="
          ...
          w-[800px] h-[400px]
          bg-gradient-to-r from-[#FF7A00]/5 via-transparent to-[#5C5CFF]/10
          rounded-full
          blur-[100px]
          -translate-x-1/2
        "
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
            ...
            <div className="hidden md:block">
              <div
                className="
                  w-20 h-1
                  bg-gradient-to-r from-[#FF7A00]/30 to-[#5C5CFF]
                  rounded-full
                  relative
                "
              >
