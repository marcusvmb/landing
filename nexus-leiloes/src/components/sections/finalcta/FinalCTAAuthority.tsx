        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
                ...
                <div className="relative">
                  ...
                  <blockquote className="relative z-10">
                    ...
                    <footer className="flex items-center gap-4">
                      <div className="w-14 h-14 bg-gradient-to-br from-[#5C5CFF] to-[#5C5CFF] rounded-full flex items-center justify-center shadow-[0_10px_25px_-8px_rgba(92,92,255,0.4)]">
            ...
            <div className="lg:col-span-5">
              <div className="h-full bg-gradient-to-br from-[#2B3259] to-[#2B3259] rounded-3xl p-8 lg:p-10 shadow-[0_30px_80px_-20px_rgba(43,50,89,0.4)] flex flex-col justify-between">
                <div>
                  {/* Badge */}
